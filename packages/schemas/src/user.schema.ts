  ...
  profile: z
    .object({
      ...
      bio: z
        .string()
        .nullable()
        .describe("Optional biographical text. Null when not provided."),
    })
...
export const CreateUserDTOSchema = z.object({
  email: z
    .string()
    .email()
    .describe("Email address for the new account. Must be globally unique."),
  password: z
    .string()
    .min(12)
    .describe(
  ...
  bio: z
    .string()
    .optional()
    .describe("Optional biographical text. Omit to leave blank."),
});
